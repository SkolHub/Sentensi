...
import { HandleGroupMoveModel, HandleSelectModel, SelectTool } from './select-tool.ts';
import { HandleGroupScaleModel, ScaleTool } from './scale-tool.ts';
import { HandleGroupRotateModel, RotateTool } from './rotate-tool.ts';
import { Point, Word } from '../../models';
import { getMedium, getSlope, groupRotateAngles, groupRotateLengths, pyth } from '../../math.ts';
import { CreateGeneral } from '../generals/create-general.ts';
import { handleGroupSelect } from '../words/word-handlers.ts';
